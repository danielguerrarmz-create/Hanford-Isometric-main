...
The raw tile data for the deployed application is live at [oxen.ai/cannoneyed/isometric-nyc-tiles](https://oxen.ai/cannoneyed/isometric-nyc-tiles).

This contains the ~32k generated tile "quadrants" in the following format:

**generations** - the generated pixel data, stored as `<xxx>_<yyy>_<hash>.png`

**generation_config.json** - metadata about the generations (e.g. centroid lat/lng and camera params)

**data.csv** - a csv with the renders and generations
