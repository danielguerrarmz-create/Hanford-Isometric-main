      ...
      try {
        ...
        if (!inputRes.ok) {
          ...
          if (contentType?.includes("application/json")) {
            ...
            throw new Error(
              err.error || `Input not found at (${newCoords.x}, ${newCoords.y})`
            );
          } else {
            throw new Error(
              "Backend server not running. Start it with: uv run python src/dark_mode_demo/server.py --input_dir <input_dir> --generation_dir <gen_dir>"
            );
          }
        }
    ...
    <div className="app">
      <header className="app-header">
        <div className="header-content">
          <h1>
            <span className="emoji">🌙</span> Dark Mode Demo
          </h1>
            ...
            <div className="tile-panel night-panel">
              ...
              {generationUrl ? (
                ...
                <div className="no-image">
                  ...
                  <p className="no-image-hint">Run generate_dark_mode.py to create</p>
                </div>
              )}
            </div>
          </div>
