...
def collect_v04_renders_nested():
    # Define paths
    project_root = Path(__file__).resolve().parents[2]
    source_dir = project_root / "synthetic_data" / "tiles" / "v04"
    target_dir = project_root / "synthetic_data" / "datasets" / "v04" / "generation" / "renders"
